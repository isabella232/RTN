...
#############################################################
#Loading time series data for Confirmed Cases
#############################################################


url = 'https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_US.csv'
df = pd.read_csv(url)
copy_to_sql(df, table_name="US_CONF", schema_name=params.SchemaName  ,if_exists="replace")


#############################################################
#Loading time series data for Death Cases
#############################################################
...
df = pd.read_csv(url)
copy_to_sql(df, table_name="US_DEATH", schema_name=params.SchemaName  ,if_exists="replace")
